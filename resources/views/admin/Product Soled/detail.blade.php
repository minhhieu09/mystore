            ...
            <div class="col-md-6 col-sm-6  ">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="col-lg-6">
                            <a href="{{route('editing.create')}}" class="btn btn-success">Thêm mới</a>
                                ...
                                @foreach ($data as $product )
                                    ...
                                    @foreach ($product->productcomponent as $key => $row)
                                        ...
                                        {{$j+=1}}
                                            ...
                                            <td>{{ $row->amount }}</td>
                                            <td>{{ $row->price }}</td>
                                            <td><a href="{{route('admin.edit',$row->id)}}"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i>Sửa</a>
                                                <a href="{{route('admin.delete', $row->id)}}"><i class="fa fa-trash-o" aria-hidden="true"></i> Xóa </a>
                                            </td>
