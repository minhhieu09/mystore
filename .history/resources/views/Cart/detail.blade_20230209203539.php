                                    ...
                                    <li>
                                        <div class="product-option">
                                            ...
                                            <div class="options" id="versionProduct" data-id="4" style="display: flex">                                      
                                                <input type="hidden" name="component" value="{{$detail_component->first()->product_id}}">
                                            </div>
                                        </div>
                                    </li>
                                    <hr>
        ...
        $('#colorid').on('change', function(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#versionProduct').html(data.data) == null;
                    $('#versionProduct').html(data.data);
                }
            });
        })
