                    ...
                    <div class="col-md-5">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @foreach ($product_component as $key => $detail_image)
                    ...
                    <div class="col-md-7">
                        <div>
                            <form action="" method="get">
                                <input type="hidden" name="id" value="{{$product_component->id}}">
                                    ...
                                    <li>
                                        <div style="display: flex">
                                            <div style="margin-right: 10px">
                                                @foreach ($product_component as $detail_color)
                ...
                success: function(e) {
                    if (e) {
                        ...
                        $.each(e.data, function(key, value) {
                            html += '<div class="form-group">' + value +
