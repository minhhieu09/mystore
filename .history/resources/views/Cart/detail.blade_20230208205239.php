                    ...
                    <div class="col-md-5">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                    <li data-target="#carouselExampleIndicators" data-slide-to="{{$detail->id}}"></li>
                            </ol>

                            <div class="carousel-inner">
                                    <div class="carousel-item active" >
                                        @foreach ($detail_images as $de )
                                            
                                        @endforeach
                                        <img src="{{$detail_image->image}}" class="d-block w-100"
                                             alt="anh">
                                    </div>
                            </div>
                    ...
                    <div class="col-md-7">
                        <div>
                            ...
                            <ul style="list-style: none;">
                                ...
                                <li>
                                    <div style="display: flex">
                                        <div style="margin-right: 10px">
                                            ...
                                            <div style="width: 20px;height: 20px;border: 2px solid;border-radius: 100%;margin-right: 5px;background-color: {{$detail_color->color_code}}">
                                            </div>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li class="btn btn-primary add" id="add-cart" style="background-color: black;color: white">
                                    THÊM VÀO GIỎ HÀNG
                                </li>
