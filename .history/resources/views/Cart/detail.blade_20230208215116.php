                    ...
                    <div class="col-md-5">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @foreach ($detail_component as $key => $detail_image)
                                    ...
                                    <li>
                                        <div style="display: flex">
                                            <div style="margin-right: 10px">
                                                @foreach ($detail_component as $detail)
                                                    
                                                @endforeach
                                                <b>Màu sắc: {{ $detail_component->color }}</b>

                                            </div>
                                            <div
                                                style="width: 20px;height: 20px;border: 2px solid;border-radius: 100%;margin-right: 5px;background-color: {{ $detail_colors->color_code }}">
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li class="mau-sanpham">
                                        <div style="width: 30%;">
                                            ...
                                            <select name="color" required>
                                                @foreach ($detail_component as $detail_color)
                                                    <option value="">
