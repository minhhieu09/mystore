...
@section('content')
    ...
    <div class="container mt-4 py-2" style="background-color: #e9e9e9">
        <form class="well form-horizontal" action="{{route('info.customer')}}" method="post" id="contact_form">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="email" placeholder="Nhập địa chỉ email" class="form-control"
                                       type="text" autocomplete="off" value="{{$customer->email}}" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input name="name" placeholder="Nhập tên của bạn" class="form-control"
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        $.each(e.data, function (index, value) {
                            html += '<option value="'+ value.district_id +'">'+ value.distric_name +'</option>'
                        });
                        console.log(e.data);
