...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('public/ad123/plugins') }}plugins/fontawesome-free/css/all.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('public/ad123/dist') }}dist/css/adminlte.min.css">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="{{ asset('public/ad123/plugins') }}plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- jQuery -->
    <script src="{{ asset('public/ad123/plugins') }}plugins/jquery/jquery.min.js"></script>
    <script>
        $.widget.bridge('uibutton', $.ui.button)
    </script>
    <!-- Bootstrap 4 -->
    <script src="{{ asset('public/ad123/plugins') }}plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- overlayScrollbars -->
    <script src="{{ asset('public/ad123/plugins') }}plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
    <!-- AdminLTE App -->
    <script src="{{ asset('public/ad123/dist') }}dist/js/adminlte.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="{{ asset('public/ad123/dist') }}dist/js/demo.js"></script>
