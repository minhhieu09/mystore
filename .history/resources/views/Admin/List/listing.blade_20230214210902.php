                            ...
                            @foreach ($data as $product)
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @endif
                                        <th scope="row"{{'rowspan'. count( $product->productcomponent )}}>{{$i++}}</th>
                                        <td {{'rowspan'. count( $product->productcomponent )}}>{{ $product->name }}</td>
                                        <td {{'rowspan'. count( $product->productcomponent )}}>{{ $product->description }}</td>
                                        <td>
                                            @if ($product->status == 0)
