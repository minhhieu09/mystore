...
Route::get('email/verify/{token}/{email}',[MailController::class,'verifyMail'])->name('email.verify');
...
Route::get('info-address',[CustomerController::class,'InfoAddress'])->name('info.address');
Route::post('info-customer',[CustomerController::class,'Info'])->name('info.customer');
...
Route::prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::get('invoice/{id}',[AdminController::class, 'detailInvoice'])->name('admin.detail');
