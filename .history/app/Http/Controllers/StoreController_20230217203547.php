...
class StoreController extends Controller
{
    ...
    public function Detail(Request $request , $id)
    {
        ...
        $assign['sameProduct'] = ProductModel::where('id', '!=', $id)->where($assign['product']->type)->where('status', 1)->take(4)->get();
        // $name = $assign['product']->name;
        $data = ProductComponentModel::where('product_id', $condition)->get()
