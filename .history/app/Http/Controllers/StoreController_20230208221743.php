...
class StoreController extends Controller
{
    ...
    public function getmemory(Request $request){
        $memory = ProductComponentModel::where('product_id', $request->product_id)->where('color_id', $request->color_id)->get();
        return response()->json(['data'=>$request->product_id,'data2'=>$request->color_id]);
    }
