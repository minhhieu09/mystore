...
class AdminController extends Controller
{
    ...
    public function update(Request $request){
        ...
        $data = [
            ...
            "description" => $dataRequest['descr'],
            "memory" => $dataRequest['name'],
            "color" => $dataRequest['name'],
            "amount" => $dataRequest['name'],
            "price" => $dataRequest['name'],
            "image" => $dataRequest['name'],
        ];
    }
    ...
    {
        $assign['invoices'] = Payment_model::all();

        return view('admin.invoice.index', $assign);
    }
    public function detailInvoice($id)
    {
        $assign['invoice'] = Payment_model::where('id', $id)->first();
        $assign['payments'] = json_decode($assign['invoice']->payment_info);
        // dd( $assign['payments']);
        return view('admin.invoice.detail', $assign);
    }
}
