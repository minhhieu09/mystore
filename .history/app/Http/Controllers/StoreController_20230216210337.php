...
class StoreController extends Controller
{
    ...
    public function getmemory(Request $request){
        ...
        $memory = ProductComponentModel::where('product_id',$dataRequest['id'])->where('color_id',$dataRequest['color']);
        
        return response()->json(['data'=> $dataRequest['id'],'data1'=> $dataRequest['color']]);
